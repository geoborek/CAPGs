...
; START - pure strategies
  (= (cost-check-unvisited-location city-loc-1) 1276)
  (= (cost-check-unvisited-location city-loc-2) 9861)
  (= (cost-check-unvisited-location city-loc-3) 8568)
  (= (cost-check-unvisited-location city-loc-4) 9882)
  (= (cost-check-unvisited-location city-loc-5) 8075)
  (= (cost-check-unvisited-location city-loc-6) 7802)
  (= (cost-check-unvisited-location city-loc-7) 2763)
  (= (cost-check-unvisited-location city-loc-8) 3670)
  (= (cost-check-unvisited-location city-loc-9) 7618)
  (= (cost-check-unvisited-location city-loc-10) 5950)
  (= (cost-check-unvisited-location city-loc-11) 2511)
  (= (cost-check-unvisited-location city-loc-12) 5126)
  (= (cost-check-unvisited-location city-loc-13) 1778)
  (= (cost-check-unvisited-location city-loc-14) 7385)
  (= (cost-check-unvisited-location city-loc-15) 5212)
  (= (cost-check-unvisited-location city-loc-16) 3583)
  (= (cost-check-unvisited-location city-loc-17) 2392)
  (= (cost-check-unvisited-location city-loc-18) 1124)
  (= (cost-check-unvisited-location city-loc-19) 5635)
  (= (cost-check-unvisited-location city-loc-20) 3838)
  (= (cost-check-unvisited-location city-loc-21) 7077)
  (= (cost-check-unvisited-location city-loc-22) 7227)
  (= (cost-check-unvisited-location city-loc-23) 9193)
  (= (cost-check-unvisited-location city-loc-24) 2389)
; END - pure strategies
 )
 (:goal (and
  (goal)
