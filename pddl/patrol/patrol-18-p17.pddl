...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 1219)
  (= (cost-check-unvisited-location city-2-loc-1) 8163)
  (= (cost-check-unvisited-location city-1-loc-2) 1933)
  (= (cost-check-unvisited-location city-2-loc-2) 4426)
  (= (cost-check-unvisited-location city-1-loc-3) 1739)
  (= (cost-check-unvisited-location city-2-loc-3) 7272)
  (= (cost-check-unvisited-location city-1-loc-4) 7631)
  (= (cost-check-unvisited-location city-2-loc-4) 2010)
  (= (cost-check-unvisited-location city-1-loc-5) 9884)
  (= (cost-check-unvisited-location city-2-loc-5) 4158)
  (= (cost-check-unvisited-location city-1-loc-6) 9098)
  (= (cost-check-unvisited-location city-2-loc-6) 2487)
  (= (cost-check-unvisited-location city-1-loc-7) 5427)
  (= (cost-check-unvisited-location city-2-loc-7) 5192)
  (= (cost-check-unvisited-location city-1-loc-8) 8422)
  (= (cost-check-unvisited-location city-2-loc-8) 9553)
  (= (cost-check-unvisited-location city-1-loc-9) 8092)
  (= (cost-check-unvisited-location city-2-loc-9) 7606)
  (= (cost-check-unvisited-location city-1-loc-10) 6575)
  (= (cost-check-unvisited-location city-2-loc-10) 9992)
  (= (cost-check-unvisited-location city-1-loc-11) 3928)
  (= (cost-check-unvisited-location city-2-loc-11) 1966)
  (= (cost-check-unvisited-location city-1-loc-12) 7190)
  (= (cost-check-unvisited-location city-2-loc-12) 3172)
  (= (cost-check-unvisited-location city-1-loc-13) 1460)
  (= (cost-check-unvisited-location city-2-loc-13) 2064)
  (= (cost-check-unvisited-location city-1-loc-14) 2165)
  (= (cost-check-unvisited-location city-2-loc-14) 9606)
; END - pure strategies
 )
 (:goal (and
  (goal)
