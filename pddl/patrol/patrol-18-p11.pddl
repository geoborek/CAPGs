...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 9920)
  (= (cost-check-unvisited-location city-2-loc-1) 5847)
  (= (cost-check-unvisited-location city-1-loc-2) 9756)
  (= (cost-check-unvisited-location city-2-loc-2) 2211)
; END - pure strategies
 )
 (:goal (and
  (goal)
