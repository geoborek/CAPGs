...
; START - pure strategies
  (= (cost-check-unvisited-location city-loc-1) 9798)
  (= (cost-check-unvisited-location city-loc-2) 5709)
  (= (cost-check-unvisited-location city-loc-3) 5510)
  (= (cost-check-unvisited-location city-loc-4) 6388)
  (= (cost-check-unvisited-location city-loc-5) 7308)
  (= (cost-check-unvisited-location city-loc-6) 1092)
  (= (cost-check-unvisited-location city-loc-7) 9753)
  (= (cost-check-unvisited-location city-loc-8) 1034)
  (= (cost-check-unvisited-location city-loc-9) 6958)
  (= (cost-check-unvisited-location city-loc-10) 8237)
  (= (cost-check-unvisited-location city-loc-11) 5069)
  (= (cost-check-unvisited-location city-loc-12) 7412)
  (= (cost-check-unvisited-location city-loc-13) 4668)
  (= (cost-check-unvisited-location city-loc-14) 4043)
  (= (cost-check-unvisited-location city-loc-15) 7080)
  (= (cost-check-unvisited-location city-loc-16) 7374)
  (= (cost-check-unvisited-location city-loc-17) 8184)
  (= (cost-check-unvisited-location city-loc-18) 5029)
  (= (cost-check-unvisited-location city-loc-19) 7711)
  (= (cost-check-unvisited-location city-loc-20) 4415)
  (= (cost-check-unvisited-location city-loc-21) 2393)
; END - pure strategies
 )
 (:goal (and
  (goal)
