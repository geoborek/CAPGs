...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 4828)
  (= (cost-check-unvisited-location city-2-loc-1) 8875)
  (= (cost-check-unvisited-location city-1-loc-2) 4325)
  (= (cost-check-unvisited-location city-2-loc-2) 5008)
  (= (cost-check-unvisited-location city-1-loc-3) 5481)
  (= (cost-check-unvisited-location city-2-loc-3) 4387)
  (= (cost-check-unvisited-location city-1-loc-4) 8931)
  (= (cost-check-unvisited-location city-2-loc-4) 6798)
  (= (cost-check-unvisited-location city-1-loc-5) 6057)
  (= (cost-check-unvisited-location city-2-loc-5) 5238)
  (= (cost-check-unvisited-location city-1-loc-6) 5469)
  (= (cost-check-unvisited-location city-2-loc-6) 6954)
  (= (cost-check-unvisited-location city-1-loc-7) 6854)
  (= (cost-check-unvisited-location city-2-loc-7) 6275)
  (= (cost-check-unvisited-location city-1-loc-8) 5642)
  (= (cost-check-unvisited-location city-2-loc-8) 6087)
  (= (cost-check-unvisited-location city-1-loc-9) 2469)
  (= (cost-check-unvisited-location city-2-loc-9) 6311)
  (= (cost-check-unvisited-location city-1-loc-10) 1707)
  (= (cost-check-unvisited-location city-2-loc-10) 4381)
  (= (cost-check-unvisited-location city-1-loc-11) 2112)
  (= (cost-check-unvisited-location city-2-loc-11) 6021)
  (= (cost-check-unvisited-location city-1-loc-12) 7993)
  (= (cost-check-unvisited-location city-2-loc-12) 1516)
  (= (cost-check-unvisited-location city-1-loc-13) 2630)
  (= (cost-check-unvisited-location city-2-loc-13) 3727)
  (= (cost-check-unvisited-location city-1-loc-14) 9913)
  (= (cost-check-unvisited-location city-2-loc-14) 8860)
; END - pure strategies
 )
 (:goal (and
  (goal)
