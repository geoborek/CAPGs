...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 5813)
  (= (cost-check-unvisited-location city-2-loc-1) 4775)
  (= (cost-check-unvisited-location city-3-loc-1) 3606)
  (= (cost-check-unvisited-location city-1-loc-2) 1842)
  (= (cost-check-unvisited-location city-2-loc-2) 2225)
  (= (cost-check-unvisited-location city-3-loc-2) 3633)
; END - pure strategies
 )
 (:goal (and
  (goal)
