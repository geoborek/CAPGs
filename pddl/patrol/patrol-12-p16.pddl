...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 5210)
  (= (cost-check-unvisited-location city-2-loc-1) 5392)
  (= (cost-check-unvisited-location city-1-loc-2) 7761)
  (= (cost-check-unvisited-location city-2-loc-2) 6582)
  (= (cost-check-unvisited-location city-1-loc-3) 1199)
  (= (cost-check-unvisited-location city-2-loc-3) 2144)
  (= (cost-check-unvisited-location city-1-loc-4) 3794)
  (= (cost-check-unvisited-location city-2-loc-4) 8192)
  (= (cost-check-unvisited-location city-1-loc-5) 6390)
  (= (cost-check-unvisited-location city-2-loc-5) 7170)
  (= (cost-check-unvisited-location city-1-loc-6) 7016)
  (= (cost-check-unvisited-location city-2-loc-6) 8213)
  (= (cost-check-unvisited-location city-1-loc-7) 2420)
  (= (cost-check-unvisited-location city-2-loc-7) 1256)
  (= (cost-check-unvisited-location city-1-loc-8) 7927)
  (= (cost-check-unvisited-location city-2-loc-8) 6496)
  (= (cost-check-unvisited-location city-1-loc-9) 7505)
  (= (cost-check-unvisited-location city-2-loc-9) 3126)
  (= (cost-check-unvisited-location city-1-loc-10) 1371)
  (= (cost-check-unvisited-location city-2-loc-10) 5137)
  (= (cost-check-unvisited-location city-1-loc-11) 4718)
  (= (cost-check-unvisited-location city-2-loc-11) 9890)
  (= (cost-check-unvisited-location city-1-loc-12) 5502)
  (= (cost-check-unvisited-location city-2-loc-12) 2948)
; END - pure strategies
 )
 (:goal (and
  (goal)
