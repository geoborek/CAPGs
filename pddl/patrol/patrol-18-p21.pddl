...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 5304)
  (= (cost-check-unvisited-location city-2-loc-1) 7224)
  (= (cost-check-unvisited-location city-3-loc-1) 9394)
; END - pure strategies
 )
 (:goal (and
  (goal)
