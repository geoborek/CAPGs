...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 1145)
  (= (cost-check-unvisited-location city-2-loc-1) 1229)
  (= (cost-check-unvisited-location city-1-loc-2) 4992)
  (= (cost-check-unvisited-location city-2-loc-2) 2164)
  (= (cost-check-unvisited-location city-1-loc-3) 6850)
  (= (cost-check-unvisited-location city-2-loc-3) 6639)
  (= (cost-check-unvisited-location city-1-loc-4) 9054)
  (= (cost-check-unvisited-location city-2-loc-4) 4053)
  (= (cost-check-unvisited-location city-1-loc-5) 1610)
  (= (cost-check-unvisited-location city-2-loc-5) 4732)
  (= (cost-check-unvisited-location city-1-loc-6) 7542)
  (= (cost-check-unvisited-location city-2-loc-6) 7770)
  (= (cost-check-unvisited-location city-1-loc-7) 1906)
  (= (cost-check-unvisited-location city-2-loc-7) 8308)
  (= (cost-check-unvisited-location city-1-loc-8) 1693)
  (= (cost-check-unvisited-location city-2-loc-8) 1452)
  (= (cost-check-unvisited-location city-1-loc-9) 2850)
  (= (cost-check-unvisited-location city-2-loc-9) 5768)
  (= (cost-check-unvisited-location city-1-loc-10) 2485)
  (= (cost-check-unvisited-location city-2-loc-10) 8262)
  (= (cost-check-unvisited-location city-1-loc-11) 8436)
  (= (cost-check-unvisited-location city-2-loc-11) 7526)
  (= (cost-check-unvisited-location city-1-loc-12) 7013)
  (= (cost-check-unvisited-location city-2-loc-12) 9730)
  (= (cost-check-unvisited-location city-1-loc-13) 9213)
  (= (cost-check-unvisited-location city-2-loc-13) 5967)
  (= (cost-check-unvisited-location city-1-loc-14) 5167)
  (= (cost-check-unvisited-location city-2-loc-14) 7421)
  (= (cost-check-unvisited-location city-1-loc-15) 9054)
  (= (cost-check-unvisited-location city-2-loc-15) 9385)
  (= (cost-check-unvisited-location city-1-loc-16) 1364)
  (= (cost-check-unvisited-location city-2-loc-16) 8712)
  (= (cost-check-unvisited-location city-1-loc-17) 1940)
  (= (cost-check-unvisited-location city-2-loc-17) 4839)
  (= (cost-check-unvisited-location city-1-loc-18) 2075)
  (= (cost-check-unvisited-location city-2-loc-18) 3691)
; END - pure strategies
 )
 (:goal (and
  (goal)
