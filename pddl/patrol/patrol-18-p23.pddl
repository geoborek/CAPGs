...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 4333)
  (= (cost-check-unvisited-location city-2-loc-1) 5718)
  (= (cost-check-unvisited-location city-3-loc-1) 3235)
  (= (cost-check-unvisited-location city-1-loc-2) 9680)
  (= (cost-check-unvisited-location city-2-loc-2) 5604)
  (= (cost-check-unvisited-location city-3-loc-2) 1000)
  (= (cost-check-unvisited-location city-1-loc-3) 3451)
  (= (cost-check-unvisited-location city-2-loc-3) 7138)
  (= (cost-check-unvisited-location city-3-loc-3) 3766)
; END - pure strategies
 )
 (:goal (and
  (goal)
