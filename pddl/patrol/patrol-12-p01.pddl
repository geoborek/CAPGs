...
; START - pure strategies
  (= (cost-check-unvisited-location city-loc-1) 5285)
  (= (cost-check-unvisited-location city-loc-2) 7078)
  (= (cost-check-unvisited-location city-loc-3) 3373)
; END - pure strategies
 )
 (:goal (and
  (goal)
