...
; START - pure strategies
  (= (cost-check-unvisited-location city-loc-1) 4054)
  (= (cost-check-unvisited-location city-loc-2) 4335)
  (= (cost-check-unvisited-location city-loc-3) 6106)
  (= (cost-check-unvisited-location city-loc-4) 1091)
  (= (cost-check-unvisited-location city-loc-5) 5428)
  (= (cost-check-unvisited-location city-loc-6) 4751)
; END - pure strategies
 )
 (:goal (and
  (goal)
