...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 3339)
  (= (cost-check-unvisited-location city-2-loc-1) 2021)
  (= (cost-check-unvisited-location city-1-loc-2) 2312)
  (= (cost-check-unvisited-location city-2-loc-2) 8501)
  (= (cost-check-unvisited-location city-1-loc-3) 5279)
  (= (cost-check-unvisited-location city-2-loc-3) 4620)
  (= (cost-check-unvisited-location city-1-loc-4) 6220)
  (= (cost-check-unvisited-location city-2-loc-4) 9635)
  (= (cost-check-unvisited-location city-1-loc-5) 4372)
  (= (cost-check-unvisited-location city-2-loc-5) 7351)
  (= (cost-check-unvisited-location city-1-loc-6) 9297)
  (= (cost-check-unvisited-location city-2-loc-6) 7147)
  (= (cost-check-unvisited-location city-1-loc-7) 7683)
  (= (cost-check-unvisited-location city-2-loc-7) 6459)
  (= (cost-check-unvisited-location city-1-loc-8) 1173)
  (= (cost-check-unvisited-location city-2-loc-8) 5466)
  (= (cost-check-unvisited-location city-1-loc-9) 7169)
  (= (cost-check-unvisited-location city-2-loc-9) 9648)
  (= (cost-check-unvisited-location city-1-loc-10) 8579)
  (= (cost-check-unvisited-location city-2-loc-10) 7331)
  (= (cost-check-unvisited-location city-1-loc-11) 4239)
  (= (cost-check-unvisited-location city-2-loc-11) 6753)
  (= (cost-check-unvisited-location city-1-loc-12) 4653)
  (= (cost-check-unvisited-location city-2-loc-12) 7350)
  (= (cost-check-unvisited-location city-1-loc-13) 2355)
  (= (cost-check-unvisited-location city-2-loc-13) 9907)
  (= (cost-check-unvisited-location city-1-loc-14) 1267)
  (= (cost-check-unvisited-location city-2-loc-14) 3663)
  (= (cost-check-unvisited-location city-1-loc-15) 8345)
  (= (cost-check-unvisited-location city-2-loc-15) 1834)
  (= (cost-check-unvisited-location city-1-loc-16) 9069)
  (= (cost-check-unvisited-location city-2-loc-16) 3666)
; END - pure strategies
 )
 (:goal (and
  (goal)
