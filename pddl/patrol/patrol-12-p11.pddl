...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 6129)
  (= (cost-check-unvisited-location city-2-loc-1) 6720)
  (= (cost-check-unvisited-location city-1-loc-2) 5643)
  (= (cost-check-unvisited-location city-2-loc-2) 4773)
; END - pure strategies
 )
 (:goal (and
  (goal)
