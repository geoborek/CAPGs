...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 3102)
  (= (cost-check-unvisited-location city-2-loc-1) 8816)
  (= (cost-check-unvisited-location city-1-loc-2) 4761)
  (= (cost-check-unvisited-location city-2-loc-2) 7142)
  (= (cost-check-unvisited-location city-1-loc-3) 2315)
  (= (cost-check-unvisited-location city-2-loc-3) 1259)
  (= (cost-check-unvisited-location city-1-loc-4) 9543)
  (= (cost-check-unvisited-location city-2-loc-4) 1066)
  (= (cost-check-unvisited-location city-1-loc-5) 9532)
  (= (cost-check-unvisited-location city-2-loc-5) 1017)
  (= (cost-check-unvisited-location city-1-loc-6) 9436)
  (= (cost-check-unvisited-location city-2-loc-6) 1840)
; END - pure strategies
 )
 (:goal (and
  (goal)
