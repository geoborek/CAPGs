...
; START - pure strategies
  (= (cost-check-unvisited-location city-loc-1) 8243)
  (= (cost-check-unvisited-location city-loc-2) 5913)
  (= (cost-check-unvisited-location city-loc-3) 5613)
  (= (cost-check-unvisited-location city-loc-4) 8446)
  (= (cost-check-unvisited-location city-loc-5) 8823)
  (= (cost-check-unvisited-location city-loc-6) 9935)
  (= (cost-check-unvisited-location city-loc-7) 7401)
  (= (cost-check-unvisited-location city-loc-8) 8660)
  (= (cost-check-unvisited-location city-loc-9) 3577)
  (= (cost-check-unvisited-location city-loc-10) 3470)
  (= (cost-check-unvisited-location city-loc-11) 2637)
  (= (cost-check-unvisited-location city-loc-12) 3210)
; END - pure strategies
 )
 (:goal (and
  (goal)
