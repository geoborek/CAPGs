...
; START - pure strategies
  (= (cost-check-unvisited-location city-loc-1) 7000)
  (= (cost-check-unvisited-location city-loc-2) 8843)
  (= (cost-check-unvisited-location city-loc-3) 2807)
  (= (cost-check-unvisited-location city-loc-4) 2167)
  (= (cost-check-unvisited-location city-loc-5) 7363)
  (= (cost-check-unvisited-location city-loc-6) 5886)
  (= (cost-check-unvisited-location city-loc-7) 3231)
  (= (cost-check-unvisited-location city-loc-8) 7657)
  (= (cost-check-unvisited-location city-loc-9) 3543)
  (= (cost-check-unvisited-location city-loc-10) 5816)
  (= (cost-check-unvisited-location city-loc-11) 6096)
  (= (cost-check-unvisited-location city-loc-12) 4279)
  (= (cost-check-unvisited-location city-loc-13) 4481)
  (= (cost-check-unvisited-location city-loc-14) 7683)
  (= (cost-check-unvisited-location city-loc-15) 4039)
  (= (cost-check-unvisited-location city-loc-16) 2527)
  (= (cost-check-unvisited-location city-loc-17) 7013)
  (= (cost-check-unvisited-location city-loc-18) 4378)
  (= (cost-check-unvisited-location city-loc-19) 9371)
  (= (cost-check-unvisited-location city-loc-20) 1895)
  (= (cost-check-unvisited-location city-loc-21) 5270)
  (= (cost-check-unvisited-location city-loc-22) 8260)
  (= (cost-check-unvisited-location city-loc-23) 2705)
  (= (cost-check-unvisited-location city-loc-24) 8823)
  (= (cost-check-unvisited-location city-loc-25) 5785)
  (= (cost-check-unvisited-location city-loc-26) 8438)
  (= (cost-check-unvisited-location city-loc-27) 9687)
  (= (cost-check-unvisited-location city-loc-28) 7958)
  (= (cost-check-unvisited-location city-loc-29) 4861)
  (= (cost-check-unvisited-location city-loc-30) 7438)
; END - pure strategies
 )
 (:goal (and
  (goal)
