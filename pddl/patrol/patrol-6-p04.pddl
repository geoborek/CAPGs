...
; START - pure strategies
  (= (cost-check-unvisited-location city-loc-1) 1787)
  (= (cost-check-unvisited-location city-loc-2) 5090)
  (= (cost-check-unvisited-location city-loc-3) 8114)
  (= (cost-check-unvisited-location city-loc-4) 6264)
  (= (cost-check-unvisited-location city-loc-5) 9420)
  (= (cost-check-unvisited-location city-loc-6) 6826)
  (= (cost-check-unvisited-location city-loc-7) 2740)
  (= (cost-check-unvisited-location city-loc-8) 2935)
  (= (cost-check-unvisited-location city-loc-9) 3714)
  (= (cost-check-unvisited-location city-loc-10) 8147)
  (= (cost-check-unvisited-location city-loc-11) 4809)
  (= (cost-check-unvisited-location city-loc-12) 8586)
; END - pure strategies
 )
 (:goal (and
  (goal)
