...
; START - pure strategies
  (= (cost-check-unvisited-location city-1-loc-1) 3109)
  (= (cost-check-unvisited-location city-2-loc-1) 7505)
  (= (cost-check-unvisited-location city-3-loc-1) 5629)
  (= (cost-check-unvisited-location city-1-loc-2) 4900)
  (= (cost-check-unvisited-location city-2-loc-2) 2333)
  (= (cost-check-unvisited-location city-3-loc-2) 3818)
  (= (cost-check-unvisited-location city-1-loc-3) 4953)
  (= (cost-check-unvisited-location city-2-loc-3) 4408)
  (= (cost-check-unvisited-location city-3-loc-3) 5694)
  (= (cost-check-unvisited-location city-1-loc-4) 1770)
  (= (cost-check-unvisited-location city-2-loc-4) 6860)
  (= (cost-check-unvisited-location city-3-loc-4) 6119)
  (= (cost-check-unvisited-location city-1-loc-5) 4422)
  (= (cost-check-unvisited-location city-2-loc-5) 3963)
  (= (cost-check-unvisited-location city-3-loc-5) 9987)
  (= (cost-check-unvisited-location city-1-loc-6) 5987)
  (= (cost-check-unvisited-location city-2-loc-6) 9492)
  (= (cost-check-unvisited-location city-3-loc-6) 2061)
  (= (cost-check-unvisited-location city-1-loc-7) 8758)
  (= (cost-check-unvisited-location city-2-loc-7) 1714)
  (= (cost-check-unvisited-location city-3-loc-7) 8355)
; END - pure strategies
 )
 (:goal (and
  (goal)
