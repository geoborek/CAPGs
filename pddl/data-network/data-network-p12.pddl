...
(:domain data-network)
(:objects
    data-0-1 data-0-3 data-0-7 data-0-8 data-1-2 data-1-5 data-1-6 data-2-4 - data
...
; START - base costs
  (= (base-process script1 server1) 24)
  (= (base-process script1 server2) 7)
  (= (base-process script1 server3) 11)
  (= (base-process script1 server4) 12)
  (= (base-process script2 server1) 22)
  (= (base-process script2 server2) 10)
  (= (base-process script2 server3) 6)
  (= (base-process script2 server4) 7)
  (= (base-process script3 server1) 24)
  (= (base-process script3 server2) 8)
  (= (base-process script3 server3) 11)
  (= (base-process script3 server4) 9)
  (= (base-process script4 server1) 22)
  (= (base-process script4 server2) 13)
  (= (base-process script4 server3) 12)
  (= (base-process script4 server4) 8)
  (= (base-process script5 server1) 24)
  (= (base-process script5 server2) 12)
  (= (base-process script5 server3) 6)
  (= (base-process script5 server4) 10)
  (= (base-process script6 server1) 17)
  (= (base-process script6 server2) 11)
  (= (base-process script6 server3) 8)
  (= (base-process script6 server4) 10)
  (= (base-process script7 server1) 22)
  (= (base-process script7 server2) 6)
  (= (base-process script7 server3) 13)
  (= (base-process script7 server4) 14)
  (= (base-process script8 server1) 19)
  (= (base-process script8 server2) 11)
  (= (base-process script8 server3) 11)
  (= (base-process script8 server4) 13)
  (= (base-process script9 server1) 21)
  (= (base-process script9 server2) 11)
  (= (base-process script9 server3) 9)
  (= (base-process script9 server4) 9)
  (= (base-process script10 server1) 23)
  (= (base-process script10 server2) 5)
  (= (base-process script10 server3) 11)
  (= (base-process script10 server4) 9)
  (= (base-process script11 server1) 19)
  (= (base-process script11 server2) 9)
  (= (base-process script11 server3) 8)
  (= (base-process script11 server4) 11)
  (= (base-process script12 server1) 24)
  (= (base-process script12 server2) 6)
  (= (base-process script12 server3) 11)
  (= (base-process script12 server4) 9)
  (= (base-process script13 server1) 24)
  (= (base-process script13 server2) 8)
  (= (base-process script13 server3) 8)
  (= (base-process script13 server4) 9)
  (= (base-process script14 server1) 17)
  (= (base-process script14 server2) 12)
  (= (base-process script14 server3) 10)
  (= (base-process script14 server4) 8)
; END - base costs

; START - pure strategies
  (= (cost-process script1 server1) 4208)
  (= (cost-process script1 server2) 4781)
  (= (cost-process script1 server3) 9269)
  (= (cost-process script1 server4) 2270)
  (= (cost-process script2 server1) 3629)
  (= (cost-process script2 server2) 1720)
  (= (cost-process script2 server3) 7160)
  (= (cost-process script2 server4) 7189)
  (= (cost-process script3 server1) 4004)
  (= (cost-process script3 server2) 5733)
  (= (cost-process script3 server3) 5109)
  (= (cost-process script3 server4) 7422)
  (= (cost-process script4 server1) 9822)
  (= (cost-process script4 server2) 3216)
  (= (cost-process script4 server3) 2320)
  (= (cost-process script4 server4) 1147)
  (= (cost-process script5 server1) 1479)
  (= (cost-process script5 server2) 7707)
  (= (cost-process script5 server3) 9826)
  (= (cost-process script5 server4) 7057)
  (= (cost-process script6 server1) 6582)
  (= (cost-process script6 server2) 6189)
  (= (cost-process script6 server3) 8598)
  (= (cost-process script6 server4) 2109)
  (= (cost-process script7 server1) 1618)
  (= (cost-process script7 server2) 8153)
  (= (cost-process script7 server3) 4005)
  (= (cost-process script7 server4) 6467)
  (= (cost-process script8 server1) 4427)
  (= (cost-process script8 server2) 7167)
  (= (cost-process script8 server3) 1857)
  (= (cost-process script8 server4) 9558)
  (= (cost-process script9 server1) 4206)
  (= (cost-process script9 server2) 6344)
  (= (cost-process script9 server3) 6368)
  (= (cost-process script9 server4) 4906)
  (= (cost-process script10 server1) 6995)
  (= (cost-process script10 server2) 4794)
  (= (cost-process script10 server3) 4127)
  (= (cost-process script10 server4) 1904)
  (= (cost-process script11 server1) 3297)
  (= (cost-process script11 server2) 1511)
  (= (cost-process script11 server3) 7600)
  (= (cost-process script11 server4) 4105)
  (= (cost-process script12 server1) 4622)
  (= (cost-process script12 server2) 5041)
  (= (cost-process script12 server3) 7827)
  (= (cost-process script12 server4) 9249)
  (= (cost-process script13 server1) 9793)
  (= (cost-process script13 server2) 4390)
  (= (cost-process script13 server3) 4009)
  (= (cost-process script13 server4) 4960)
  (= (cost-process script14 server1) 3412)
  (= (cost-process script14 server2) 3651)
  (= (cost-process script14 server3) 6963)
  (= (cost-process script14 server4) 9081)
; END - pure strategies

    (SCRIPT-IO script1 data-0-8 data-0-7 data-1-5)
    (SCRIPT-IO script2 data-0-8 data-0-7 data-1-6)
    (SCRIPT-IO script3 data-0-8 data-0-1 data-1-2)
    (SCRIPT-IO script4 data-1-5 data-1-2 data-2-4)
    (SCRIPT-IO script5 data-1-6 data-1-5 data-2-4)
    (SCRIPT-IO script6 data-1-5 data-0-7 data-2-4)
    (SCRIPT-IO script7 data-1-2 data-0-8 data-2-4)
    (SCRIPT-IO script8 data-1-5 data-1-2 data-2-4)
    (SCRIPT-IO script9 data-1-2 data-1-5 data-2-4)
    (SCRIPT-IO script10 data-1-2 data-1-5 data-2-4)
    (SCRIPT-IO script11 data-0-3 data-0-8 data-1-5)
    (SCRIPT-IO script12 data-1-6 data-1-2 data-2-4)
    (SCRIPT-IO script13 data-1-6 data-0-3 data-2-4)
    (SCRIPT-IO script14 data-0-8 data-0-1 data-1-6)
