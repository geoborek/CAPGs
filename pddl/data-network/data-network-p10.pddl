...
(:domain data-network)
(:objects
    data-0-1 data-0-3 data-0-5 data-1-4 data-2-2 data-2-6 - data
...
; START - base costs
  ...
  (= (base-process script5 server4) 9)
  ...
  (= (base-process script7 server1) 25)
  ...
  (= (base-process script8 server2) 6)
  (= (base-process script8 server3) 10)
  (= (base-process script8 server4) 14)
  (= (base-process script9 server1) 21)
  (= (base-process script9 server2) 4)
  (= (base-process script9 server3) 13)
  (= (base-process script9 server4) 4)
  (= (base-process script10 server1) 16)
...
; START - pure strategies
  (= (cost-process script1 server1) 9184)
  (= (cost-process script1 server2) 3648)
  (= (cost-process script1 server3) 7959)
  (= (cost-process script1 server4) 1953)
  (= (cost-process script2 server1) 9827)
  (= (cost-process script2 server2) 5159)
  (= (cost-process script2 server3) 4717)
  (= (cost-process script2 server4) 9810)
  (= (cost-process script3 server1) 3435)
  (= (cost-process script3 server2) 7671)
  (= (cost-process script3 server3) 7022)
  (= (cost-process script3 server4) 7152)
  (= (cost-process script4 server1) 9790)
  (= (cost-process script4 server2) 8851)
  (= (cost-process script4 server3) 4434)
  (= (cost-process script4 server4) 2051)
  (= (cost-process script5 server1) 9594)
  (= (cost-process script5 server2) 2586)
  (= (cost-process script5 server3) 7446)
  (= (cost-process script5 server4) 1855)
  (= (cost-process script6 server1) 9793)
  (= (cost-process script6 server2) 1855)
  (= (cost-process script6 server3) 7746)
  (= (cost-process script6 server4) 3741)
  (= (cost-process script7 server1) 3945)
  (= (cost-process script7 server2) 8862)
  (= (cost-process script7 server3) 6602)
  (= (cost-process script7 server4) 7575)
  (= (cost-process script8 server1) 3148)
  (= (cost-process script8 server2) 6290)
  (= (cost-process script8 server3) 3015)
  (= (cost-process script8 server4) 9659)
  (= (cost-process script9 server1) 7745)
  (= (cost-process script9 server2) 3488)
  (= (cost-process script9 server3) 6272)
  (= (cost-process script9 server4) 6968)
  (= (cost-process script10 server1) 4324)
  (= (cost-process script10 server2) 6367)
  (= (cost-process script10 server3) 9238)
  (= (cost-process script10 server4) 8565)
  (= (cost-process script11 server1) 7642)
  (= (cost-process script11 server2) 8287)
  (= (cost-process script11 server3) 6565)
  (= (cost-process script11 server4) 6343)
; END - pure strategies

    (SCRIPT-IO script1 data-0-1 data-0-5 data-1-4)
    (SCRIPT-IO script2 data-1-4 data-0-5 data-2-6)
    (SCRIPT-IO script3 data-1-4 data-0-3 data-2-2)
    (SCRIPT-IO script4 data-1-4 data-0-5 data-2-6)
    (SCRIPT-IO script5 data-1-4 data-0-5 data-2-6)
    (SCRIPT-IO script6 data-0-5 data-0-3 data-1-4)
    (SCRIPT-IO script7 data-0-5 data-0-1 data-1-4)
    (SCRIPT-IO script8 data-0-1 data-0-3 data-1-4)
    (SCRIPT-IO script9 data-1-4 data-0-5 data-2-2)
    (SCRIPT-IO script10 data-1-4 data-0-1 data-2-2)
    (SCRIPT-IO script11 data-1-4 data-0-3 data-2-6)
