...
; START - base costs
  (= (base-process script1 server1) 14)
  (= (base-process script1 server2) 5)
  (= (base-process script1 server3) 8)
  (= (base-process script1 server4) 6)
  (= (base-process script2 server1) 16)
  (= (base-process script2 server2) 9)
  (= (base-process script2 server3) 7)
  (= (base-process script2 server4) 7)
  (= (base-process script3 server1) 17)
  (= (base-process script3 server2) 14)
  (= (base-process script3 server3) 9)
  (= (base-process script3 server4) 11)
  ...
  (= (base-process script5 server1) 21)
  ...
  (= (base-process script6 server4) 8)
  (= (base-process script7 server1) 21)
  (= (base-process script7 server2) 13)
  (= (base-process script7 server3) 10)
  (= (base-process script7 server4) 11)
  (= (base-process script8 server1) 18)
  (= (base-process script8 server2) 9)
  (= (base-process script8 server3) 9)
  (= (base-process script8 server4) 9)
  (= (base-process script9 server1) 10)
  (= (base-process script9 server2) 13)
  (= (base-process script9 server3) 9)
  (= (base-process script9 server4) 10)
  (= (base-process script10 server1) 28)
  (= (base-process script10 server2) 11)
  (= (base-process script10 server3) 13)
  (= (base-process script10 server4) 14)
; END - base costs

; START - pure strategies
  (= (cost-process script1 server1) 1653)
  (= (cost-process script1 server2) 9143)
  (= (cost-process script1 server3) 2142)
  (= (cost-process script1 server4) 4676)
  (= (cost-process script2 server1) 1911)
  (= (cost-process script2 server2) 1983)
  (= (cost-process script2 server3) 7752)
  (= (cost-process script2 server4) 8402)
  (= (cost-process script3 server1) 2673)
  (= (cost-process script3 server2) 5746)
  (= (cost-process script3 server3) 7835)
  (= (cost-process script3 server4) 5369)
  (= (cost-process script4 server1) 1565)
  (= (cost-process script4 server2) 2748)
  (= (cost-process script4 server3) 4834)
  (= (cost-process script4 server4) 8721)
  (= (cost-process script5 server1) 1472)
  (= (cost-process script5 server2) 8675)
  (= (cost-process script5 server3) 4865)
  (= (cost-process script5 server4) 1165)
  (= (cost-process script6 server1) 7195)
  (= (cost-process script6 server2) 4946)
  (= (cost-process script6 server3) 1567)
  (= (cost-process script6 server4) 3069)
  (= (cost-process script7 server1) 4598)
  (= (cost-process script7 server2) 4039)
  (= (cost-process script7 server3) 7304)
  (= (cost-process script7 server4) 7137)
  (= (cost-process script8 server1) 4364)
  (= (cost-process script8 server2) 7143)
  (= (cost-process script8 server3) 7303)
  (= (cost-process script8 server4) 4577)
  (= (cost-process script9 server1) 7015)
  (= (cost-process script9 server2) 7540)
  (= (cost-process script9 server3) 9201)
  (= (cost-process script9 server4) 4933)
  (= (cost-process script10 server1) 7920)
  (= (cost-process script10 server2) 1880)
  (= (cost-process script10 server3) 1460)
  (= (cost-process script10 server4) 4209)
; END - pure strategies
