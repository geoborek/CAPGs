...
; START - base costs
  (= (base-process script1 server1) 16)
  ...
  (= (base-process script3 server1) 16)
  (= (base-process script3 server2) 10)
  (= (base-process script3 server3) 10)
  (= (base-process script4 server1) 26)
  ...
  (= (base-process script6 server3) 11)
  ...
  (= (base-process script8 server2) 7)
  (= (base-process script8 server3) 6)
  (= (base-process script9 server1) 18)
  (= (base-process script9 server2) 10)
  (= (base-process script9 server3) 13)
  (= (base-process script10 server1) 22)
  (= (base-process script10 server2) 8)
  (= (base-process script10 server3) 12)
; END - base costs

; START - pure strategies
  (= (cost-process script1 server1) 3514)
  (= (cost-process script1 server2) 9444)
  (= (cost-process script1 server3) 9439)
  (= (cost-process script2 server1) 9172)
  (= (cost-process script2 server2) 5253)
  (= (cost-process script2 server3) 8805)
  (= (cost-process script3 server1) 7588)
  (= (cost-process script3 server2) 8294)
  (= (cost-process script3 server3) 1663)
  (= (cost-process script4 server1) 3869)
  (= (cost-process script4 server2) 7254)
  (= (cost-process script4 server3) 4437)
  (= (cost-process script5 server1) 8879)
  (= (cost-process script5 server2) 9473)
  (= (cost-process script5 server3) 6958)
  (= (cost-process script6 server1) 5195)
  (= (cost-process script6 server2) 6081)
  (= (cost-process script6 server3) 4598)
  (= (cost-process script7 server1) 5689)
  (= (cost-process script7 server2) 5718)
  (= (cost-process script7 server3) 4428)
  (= (cost-process script8 server1) 7999)
  (= (cost-process script8 server2) 4473)
  (= (cost-process script8 server3) 8611)
  (= (cost-process script9 server1) 8549)
  (= (cost-process script9 server2) 4467)
  (= (cost-process script9 server3) 8928)
  (= (cost-process script10 server1) 6228)
  (= (cost-process script10 server2) 3365)
  (= (cost-process script10 server3) 9942)
; END - pure strategies
