...
; START - base costs
  ...
  (= (base-process script6 server3) 13)
  (= (base-process script7 server1) 16)
  (= (base-process script7 server2) 8)
  ...
  (= (base-process script9 server1) 26)
  (= (base-process script9 server2) 12)
  ...
  (= (base-process script11 server3) 6)
; END - base costs

; START - pure strategies
  (= (cost-process script1 server1) 3449)
  (= (cost-process script1 server2) 9803)
  (= (cost-process script1 server3) 8097)
  (= (cost-process script2 server1) 8554)
  (= (cost-process script2 server2) 5385)
  (= (cost-process script2 server3) 9883)
  (= (cost-process script3 server1) 3732)
  (= (cost-process script3 server2) 9287)
  (= (cost-process script3 server3) 2596)
  (= (cost-process script4 server1) 1092)
  (= (cost-process script4 server2) 4846)
  (= (cost-process script4 server3) 9395)
  (= (cost-process script5 server1) 3274)
  (= (cost-process script5 server2) 2001)
  (= (cost-process script5 server3) 5815)
  (= (cost-process script6 server1) 5157)
  (= (cost-process script6 server2) 1840)
  (= (cost-process script6 server3) 5948)
  (= (cost-process script7 server1) 1762)
  (= (cost-process script7 server2) 2025)
  (= (cost-process script7 server3) 5110)
  (= (cost-process script8 server1) 8494)
  (= (cost-process script8 server2) 9253)
  (= (cost-process script8 server3) 3065)
  (= (cost-process script9 server1) 5590)
  (= (cost-process script9 server2) 8438)
  (= (cost-process script9 server3) 1335)
  (= (cost-process script10 server1) 7091)
  (= (cost-process script10 server2) 1946)
  (= (cost-process script10 server3) 6693)
  (= (cost-process script11 server1) 8395)
  (= (cost-process script11 server2) 5938)
  (= (cost-process script11 server3) 9247)
; END - pure strategies
