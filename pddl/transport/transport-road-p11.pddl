...
; START - pure strategies
  (= (cost-drive city-1-loc-2 city-1-loc-1) 9912)
  (= (cost-drive city-1-loc-1 city-1-loc-2) 1125)
  (= (cost-drive city-2-loc-2 city-2-loc-1) 7828)
  (= (cost-drive city-2-loc-1 city-2-loc-2) 5257)
  (= (cost-drive city-1-loc-2 city-2-loc-2) 6247)
  (= (cost-drive city-2-loc-2 city-1-loc-2) 9198)
; END - pure strategies
